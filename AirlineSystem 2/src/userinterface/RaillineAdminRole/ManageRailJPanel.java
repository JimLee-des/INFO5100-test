 ...
 */
package userinterface.RaillineAdminRole;

import Business.Railline.RailLine;
import Business.Railline.Rail;
...
public class ManageRailJPanel extends javax.swing.JPanel {
        ...
        if(selectedRow>=0){
            ...
            for (RailLine al : system.getRailLineDirectory().getRailLineList()) {
                if(al.getName().equals(userAccount.getName())){
                    for(int i = 0; i< al.getRailList().size(); i++){
                        if(al.getRailList().get(i).getId().equals(airplane_id)){
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        for (RailLine al : system.getRailLineDirectory().getRailLineList()) {
            if(al.getName().equals(userAccount.getName())){
                for(int i = 0; i< al.getRailList().size(); i++){
                    if(al.getRailList().get(i).getId().equals(id)){
                        if (al.getRailList().get(i).getId().equals(airplane_id)) {
                            JOptionPane.showMessageDialog(null,"  Airplane ID already exists ");
                        }else{
                            al.getRailList().get(i).setId(airplane_id);
                            al.getRailList().get(i).setCapacity(capacity);
                            al.getRailList().get(i).setRepairStatus(rs);
                            populatetblAp();
                ...
                if(al.getName().equals(userAccount.getName())){
                    for(int i = 0; i< al.getRailList().size(); i++){
                        for(int a = 0; a< al.getFlightList().size(); a++){
                            if(al.getRailList().get(i).getId().equals(id) && al.getFlightList().get(a).getRail_id().equals(fid) && al.getRailList().get(i).isUsingStatus()==false && al.getFlightList().get(a).getRail_id() == null){
                                al.getRailList().get(i).setUsingStatus(true);
                                al.getFlightList().get(a).setAirplane_id(al.getRailList().get(i).getId());
            ...
            if(al.getName().equals(userAccount.getName())){
                for(Train fl : al.getFlightList()){
                    if(fl.isStatus()==false){
                        ...
                        row[5] = (fl.getRail_id()==null)? "Not Assigned Yet" : fl.getRail_id();
                        row[6] = fl.getCost();
                        row[7] = al.getName();
                        model.addRow(row);
                    }
