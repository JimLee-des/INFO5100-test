...
import Business.Railline.RailCrew;
        ...
        if (system.getUserAccountDirectory().checkIfUsernameIsUnique(uname)==false) {
            ...
            for(RailLine al : system.getRailLineDirectory().getRailLineList()){
                if(al.getName().equals(userAccount.getName())){
                    ...
                    System.out.println(al.getrailCrewList());
                }
            }
    ...
    private void btnConfirmActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnConfirmActionPerformed
        ...
        if (system.getUserAccountDirectory().checkIfUsernameIsUnique(uname)==false) {
            ...
            for(UserAccount ua : system.getUserAccountDirectory().getUserAccountList()){
                ...
                //                if(ua.getName()==null){
                    //                    continue;
                    //                }else if(ua.getName().equals((String) tblAc.getValueAt(selectRow, 0))){
                    //                    system.getUserAccountDirectory().updateUserAccount(ua,uname,password);
                    //                }
            }
            for(RailLine al : system.getRailLineDirectory().getRailLineList()){
                if(al.getName().equals(userAccount.getName())){
                    for(RailCrew ac :al.getrailCrewList()){
